...
const Projects = [
  ...
  },
  {
    title: 'Meals',
    description:
      'Introducing our semi-automated food delivery website! Place your order and our expert cooks will see it from the other side.',
    techs: ['React', 'Context', 'HTML', 'CSS', 'Javascript', 'Npm'],
    Llink: 'https://mhamad-raad.github.io/React-Meals/',
    GLink: 'https://github.com/Mhamad-Raad/React-Meals',
    img: Meals,
  },
  {
    title: 'Cash Flow',
